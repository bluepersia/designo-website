...
{
    el:Element;
    constructor (dataType:string, type:string, el:Element)
    {
        this.el = el;
        
        this.init (dataType, type);
    }

    async init (dataType:string, type:string)
    {
        await instantiateCards (dataType, type, this.el);
    }
}
