interface CardClassConstructor<TCard, IData> {
    new (parent: Element, data: IData): TCard;
  }
export default class CardGrid<TCard, IData>
{
    el:Element;
    CardClass: CardClassConstructor<TCard, IData>;
    dataType:string;
    type:string;

    constructor (dataType:string, CardClass: CardClassConstructor<TCard, IData>, type:string, el:Element)
    {
        this.el = el;
